module github.com/firewolfit/go_pkg
...
require (
	code.byted.org/aiops/apm_vendor_byted v0.0.15 // indirect
	code.byted.org/aiops/metrics_codec v0.0.11 // indirect
	code.byted.org/aiops/monitoring-common-go v0.0.2 // indirect
	...
	code.byted.org/duanyi.aster/gopkg v0.0.1 // indirect
	...
	code.byted.org/gopkg/logs/v2 v2.1.48 // indirect
	...
	code.byted.org/gopkg/metrics/v4 v4.0.24 // indirect
	code.byted.org/gopkg/metrics_core v0.0.22 // indirect
	...
	code.byted.org/log_market/ttlogagent_gosdk/v4 v4.0.47 // indirect
